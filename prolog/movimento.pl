...
listadecasasRei(X,Y,T,R) :-
  ...
  R7 = [_|T7],
  R8 = [_|T8],
  pegaCabeca(T1,Cor,T,C1),
  pegaCabeca(T2,Cor,T,C2),
  pegaCabeca(T3,Cor,T,C3),
  pegaCabeca(T4,Cor,T,C4),
  pegaCabeca(T5,Cor,T,C5),
  pegaCabeca(T6,Cor,T,C6),
  pegaCabeca(T7,Cor,T,C7),
  pegaCabeca(T8,Cor,T,C8),
  append(C1,C2,S1),
  append(S1,C3,S2),   
  append(S2,C4,S3),
  append(S3,C5,S4),
